...
- the active sales workbook in `erp-data/` whose filename contains `sales`
...
Use the same approach for sales workbooks when the newer file replaces, rather
than supplements, the previous reporting period.
